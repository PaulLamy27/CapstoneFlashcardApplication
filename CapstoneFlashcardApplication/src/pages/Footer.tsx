...
const Footer = () => {
  ...
  return (
    <div className='min-h-screen flex flex-col justify-center items-center text-center text-skin-base py-16 px-4'>
        <div>
        <h1 className='text-3xl font-bold text-skin-header m-4'>CARDMENTOR.</h1>
        ...
        <div className='lg:col-span-3'>
            <div>
                <h6 className='font-medium text-skin-mid'>Contact</h6>
                <ul>
