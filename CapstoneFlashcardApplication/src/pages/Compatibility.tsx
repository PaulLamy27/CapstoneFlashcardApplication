...
const Compatibility = () => {
  return (
    <div className='w-full py-16 px-4 text-skin-base'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
            <div className='flex flex-col justify-center'>
                <p className='text-skin-header font-bold'>COMPATIBILITY</p>
            ...
            <img className='w-[500px] mx-auto my-4 border-skin-dark border-2' src={phone} alt="/" />
        </div>
    </div>
  )
}
